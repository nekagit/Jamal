<template>
    <section class="section h-screen w-full">
    <div ref="sectionCard" class="sectionCard grid place-content-center"><ImageSlider :image="getImageSource(selectedImageIndex)" />
    </div>
    <input class="range-slider" type="range" min="1" max="10" v-model="selectedImageIndex" id="imgRange" />
  </section>
</template>
...
const selectedImageIndex = ref(2);
